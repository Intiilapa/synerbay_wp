<?php require $headerPartialFile;?>
    ...
    <p>
        You have received an order request from <?php echo $customerName;?>. You can accept or reject the order. As soon as you accept, we will add the ordered quantity to your offer.
