...
function load_vendor_offers_query_var( $vars ) {
    $vars[] = 'offers';

    return $vars;
}
//Show offer applies (Permalink)
add_filter('dokan_query_var_filter', 'load_vendor_offers_query_var');
 ...
 * @return void
 */
function load_vendor_offers_rewrite_rules( $custom_store_url ) {
 ...
 * @return string
 */
function load_vendor_offer_tab_template( $template ) {
...
add_action('dokan_load_custom_template', 'load_vendor_offer_tab_template');
...
// * @return mixed
// */
//function add_vendor_offers_tab($tabs, $store_id)
//{
//    $tabs['offer'] = [
//        'title' => __( 'Offers', 'dokan-lite' ),
//        'url'   => dokan_get_vendor_offers_url($store_id),
//    ];
//
//    return $tabs;
//}
